                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:block">
                        <div className="ml-4 flex items-center md:ml-6">
                            ...
                            <div className="ml-3">
                                <a href="#" className="text-lg rounded-full border-2  hover:bg-gradient-to-l
                                 to-blue-500 to-95% from-indigo-500 duration-500  hover:text-white py-2 px-5 uppercase" >Buy Course </a>
                            </div>
                        </div>
                    </div>
                </div>
